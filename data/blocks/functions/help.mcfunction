...
tellraw @s [{"text": "moahblock.kill","color":"#88ff88"},{"text":" - ","color":"#aaaaaa"},{"text": "Kills any block display withim a","color": "#aaffff"},{"text":" 3x3 ","color": "#aaaaff"},{"text":"area.","color": "#aaffff"}]
