...
data merge entity @e[type=minecraft:block_display,limit=1,distance=..1,sort=nearest] {transformation:{scale:[1.01f,.6251f,1.01f]}}
tag @e[type=minecraft:block_display,distance=..1, sort=nearest,limit=1] add SnowLayer5
...
execute at @e[type=minecraft:block_display, distance=..1,limit=1] at @s run setblock ~ ~ ~ minecraft:snow[layers=5]