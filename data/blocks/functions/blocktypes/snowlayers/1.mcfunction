...
data merge entity @e[type=minecraft:block_display,limit=1,distance=..1] {transformation:{scale:[1.01f,.1251f,1.01f]}}
...
execute at @e[type=minecraft:block_display, distance=..1,limit=1] at @s run setblock ~ ~ ~ minecraft:snow[layers=1]